...
import { X, Server, ShieldCheck, FileCode, Volume2, Globe, Info } from "lucide-react"
      ...
      <div className="flex flex-col w-[480px] max-h-[80%] bg-card border border-border rounded-xl shadow-2xl shadow-black/40 overflow-hidden">
        ...
        <div className="flex flex-col gap-5 p-5 overflow-y-auto">
          ...
          <SettingSection title="认证信息" icon={<ShieldCheck className="w-3.5 h-3.5 text-primary" />}>
            ...
            <SettingRow label="Client-Id" value="c9a1e8d4-...7b3f" mono />
          </SettingSection>
          ...
          <SettingSection title="平台适配" icon={<Globe className="w-3.5 h-3.5 text-primary" />}>
            ...
            <SettingRow label="音频采集" value="CoreAudio + BlackHole" />
            <SettingRow label="虚拟麦克风" value="BlackHole 2ch" />
            <SettingRow label="回声消除" value="策略性暂停采集 (AEC Phase 2)" />
          </SettingSection>
          ...
          <SettingSection title="工程信息" icon={<FileCode className="w-3.5 h-3.5 text-primary" />}>
            ...
            <SettingRow label="音频层" value="cpal + rubato + webrtc-vad" />
          </SettingSection>
